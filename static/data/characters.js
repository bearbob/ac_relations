const raw_data = {
  ...
  "links": [
    ...
    /*
    {
      ...
      "description": "Tadamir ist Alba zufällig auf dem Markt 'Der Nabel' über den Weg gelaufen und hat sie, aufgrund der gleichen Gestalt, mit Jin verwechselt. Es hat einen Moment gedauert, bis er seinen Irrtum bemerkt hat.",
      "value": 1
    },
    {
      "source": "Parmigianino",
      "target": "Alba",
      "id": "Zufällige Begegnung",
      "description": "Nino hat Alba im Stadtpark der Stadt des Riesen gesehen und schnell verstanden, dass die Elfe vermutlich die Person ist, nach der Jin sucht.",
      "episode": 12,
      "value": 1
    },
    */
